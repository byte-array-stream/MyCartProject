...
public class MyCartServiceOrdinaryTest {
	...
	public void dataSetup() {
		...
		item2 =new Item("Tomato","Tomato",112.00, "VEGETABLES");
		item3 =new Item("Shirt","Shirt",1000.00, "CLOTHS");
	...
	public void testCalcualateNetAmount_WITH_GROCERY() {
		...
		list1.add(item4);
		list1.add(item5);
		Bill bill1 = new Bill("102", Calendar.getInstance(), "C1", "ORDINARY", list1);
		Double netAmountExpected = 2102.00;
	...
	public void testCalcualateNetAmount_NO_GROCERY() {
		Bill bill1 = new Bill("102", Calendar.getInstance(), "C1", "ORDINARY", list1);
		Double netAmountExpected = 1152.00;
		assertEquals(netAmountExpected, service.calcualateNetAmount(bill1).getNetAmount());
	}
	...
	public void testCalcualateNetAmount_ONLY_GROCERY() {
		Item item4 =new Item("Grocery1","Grocery1",1000.00, "GROCERY");
		Item item5 =new Item("Grocery2","Grocery2",210.00, "GROCERY");
		list1.clear();
		list1.add(item4);
		list1.add(item5);
		Bill bill1 = new Bill("102", Calendar.getInstance(), "C1", "ORDINARY", list1);
		Double netAmountExpected = 1150.00;
		assertEquals(netAmountExpected, service.calcualateNetAmount(bill1).getNetAmount());
	}
