...
public class MyCartServiceAffiliatedTest {
	...
	public void testCalcualateNetAmount_WITH_GROCERY() {
		...
		list1.add(item4);
		list1.add(item5);
		Bill bill1 = new Bill("102", Calendar.getInstance(), "C1", "AFFILIATED", list1);
		Double netAmountExpected = 1035.00;
	...
	public void testCalcualateNetAmount_NO_GROCERY() {
		Bill bill1 = new Bill("102", Calendar.getInstance(), "C1", "AFFILIATED", list1);
		Double netAmountExpected = 85.00;
		assertEquals(netAmountExpected, service.calcualateNetAmount(bill1).getNetAmount());
	}
