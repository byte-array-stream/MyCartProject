...
public class MyCartServiceEmployeeTest {
	...
	public void dataSetup() {
		...
		item2 =new Item("Tomato","Tomato",3000.00, "VEGETABLES");
		item3 =new Item("Shirt","Shirt",4000.00, "CLOTHS");
	...
	public void testCalcualateNetAmount_WITH_GROCERY() {
		...
		list1.add(item4);
		list1.add(item5);
		Bill bill1 = new Bill("102", Calendar.getInstance(), "C1", "EMPLOYEE", list1);
		Double netAmountExpected = 5565.00;
	...
	public void testCalcualateNetAmount_NO_GROCERY() {
		Bill bill1 = new Bill("102", Calendar.getInstance(), "C1", "EMPLOYEE", list1);
		Double netAmountExpected = 4615.00;
		assertEquals(netAmountExpected, service.calcualateNetAmount(bill1).getNetAmount());
	}
